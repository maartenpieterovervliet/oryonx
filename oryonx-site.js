...
(()=>{const link=document.querySelector('link[href*="oryonx-page-palette.css"]');if(!link)return;const url=new URL(link.href,location.href);if(url.searchParams.get("rev")!=="20260907-petrol-contact"){url.searchParams.set("rev","20260907-petrol-contact");link.href=url.href;}})();
