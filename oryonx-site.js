...
(()=>{const link=document.querySelector('link[href*="oryonx-page-palette.css"]');if(!link)return;const url=new URL(link.href,location.href);if(url.searchParams.get("rev")!=="20260907-dark-knowledge"){url.searchParams.set("rev","20260907-dark-knowledge");link.href=url.href;}})();
